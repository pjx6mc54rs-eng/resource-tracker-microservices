...
export default function MessagesPage() {
  ...
  const activePeerStatus = activeChannel?.type === 'DIRECT' ? (activeChannel.online ? 'En ligne' : 'Hors ligne') : activeChannel?.type === 'PROJECT' ? 'Discussion de projet' : activeChannel?.type === 'GROUP' ? 'Groupe de discussion' : ''
